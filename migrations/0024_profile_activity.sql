-- Recent activity on the public profile: the 20 most recent
...
--
-- Update: the profile Activity section and its eye toggle were
-- removed. The column stays — the followee activity feed (
