...
// "Streaming" strip for the show and movie pages (issues #144, #291, #310).
...
// (issue #310). TMDB only exposes its own watch page URL, which itself just
...
// cached payload may still carry). `watch` is optional because a pre-#144
